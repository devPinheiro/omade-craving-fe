...
export default function TermsOfService() {
  useSEO({
    ...
    description:
      'Terms and conditions for using Omade Cravings website and ordering our artisanal cakes.',
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        ...
        <p className="text-xs sm:text-sm text-gray-500 mb-8 sm:mb-10">Last updated: {new Date().toLocaleDateString('en-NG')}</p>

        <div className="prose prose-gray max-w-none space-y-6 sm:space-y-8 text-gray-600">
          <section>
          ...
          <section>
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 sm:mb-3">2. Use of Our Website</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 sm:mb-3">3. Orders and Payment</h2>
          ...
          <section>
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 sm:mb-3">4. Delivery and Fulfillment</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 sm:mb-3">5. Refunds and Cancellations</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 sm:mb-3">6. Products and Allergens</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 sm:mb-3">7. Intellectual Property</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 sm:mb-3">9. Changes to Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 sm:mb-3">10. Contact</h2>
            {/* <p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <Link to="/" className="text-sm sm:text-base text-gray-900 font-medium hover:underline">
            ← Back to Home
          </Link>
        </div>
      </div>
